    ...
    <rasterrenderer opacity="1" alphaBand="0" classificationMax="100" classificationMinMaxOrigin="User" band="1" classificationMin="0" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0">
          <item alpha="255" value="0" label="0 %" color="#ffffcc"/>
          <item alpha="255" value="25" label="25 %" color="#a1dab4"/>
          <item alpha="255" value="50" label="50 %" color="#41b6c4"/>
          <item alpha="255" value="75" label=" 75 %" color="#2c7fb8"/>
          <item alpha="255" value="100" label="100 %" color="#253494"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
